		...
		<div class="well well-small">
			<ul class="nav nav-list">
				...
				<li><a class="totalInCart" href="cart.html"><strong>
							Da mua <span class="badge badge-warning pull-right"
			...
			<c:if test="${featureproducts.size() > 0 }">
				<ul class="thumbnails">
					...
					<c:forEach var="item" items="${featureproducts }" varStatus="loop">
						<li class="span4">
							<div class="thumbnail">
								<a class="zoomTool" href="product_details.html"
									...
									VIEW </a> <a href="product_details/${item.id_product }"> <img
						...
						<c:if test="${(loop.index + 1) % 3 == 0 || (loop.index + 1) == featureproducts.size() }">
							</ul>
