		...
		<div class="span9">
			...
			<div class="well well-small">
					...
					<div class="span7">
						...
						<form class="form-horizontal qtyFrm" method="get" action="<c:url value="/addCart/${product.id_product }"/>">
							<div class="control-group">
								...
								<div class="controls">
									<input type="number" min="01" value="1" class="span6"
										placeholder="Qty.">
								</div>
							</div>
							...
							<p>
								<button type="submit" class="shopBtn">
									<span class=" icon-shopping-cart"></span> Them vao gio hang
								</button>
						</form>
					</div>
				</div>
				...
				<ul id="productDetail" class="nav nav-tabs">
					<li class="active"><a href="home" data-toggle="tab">Chi tiet san pham</a></li>
					<li class=""><a href="#profile" data-toggle="tab">San pham lien quan</a></li>
