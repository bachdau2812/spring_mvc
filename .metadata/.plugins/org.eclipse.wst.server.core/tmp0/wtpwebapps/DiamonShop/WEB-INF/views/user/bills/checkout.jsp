					...
					<div class="well">
						...
						<form:form action="checkout" method="POST" modelAttribute="bills" class="form-horizontal">
							...
							<div class="control-group">
								<label class="control-label">Ho ten <sup>*</sup></label>
								<div class="controls">
									<form:input type="text" placeholder="Nhap ho ten" path="display_name"/>
								</div>
							</div>
							<div class="control-group">
								<label class="control-label">Email <sup>*</sup></label>
								<div class="controls">
									<form:input type="email" placeholder="Nhap email" path="username"/>
								</div>
							</div>
							<div class="control-group">
								<label class="control-label">Lien he <sup>*</sup></label>
								<div class="controls">
									<form:input type="text" placeholder="Nhap so dien thoai" path="phone"/>
								</div>
							</div>
							<div class="control-group">
								<label class="control-label">Dia chi <sup>*</sup></label>
								<div class="controls">
									<form:textarea path="address" rows="5" col="30"/>
								</div>
							</div>
							<div class="control-group">
								<label class="control-label">Ghi chu <sup>*</sup></label>
								<div class="controls">
							...
							<div class="control-group">
								<div class="controls">
									<input type="submit" name="submitAccount" value="Thanh toan"
