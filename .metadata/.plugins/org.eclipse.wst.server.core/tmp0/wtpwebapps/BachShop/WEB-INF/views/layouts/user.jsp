...
-->
	...
	<script src="<c:url value="/assets/user/js/js/jquery.easing-1.3.min.js"/>"></script>
	<script src="<c:url value="/assets/user/js/js/jquery.scrollTo-1.4.3.1-min.js"/>"></script>
	<script src="<c:url value="/assets/user/js/js/shop.js"/>"></script>
</body>
</html>
